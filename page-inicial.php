...
<body>
    ...
    <div class="row destaque">
        <h1>Bem Vindo</h1>
        <p>O Hotel Universitario nasceu na Universidade Eduardo Mondlane, como projeto Semestral na cadeira de
            Desenvolvimento de Aplicacoes WEB.<br>Universidade Eduardo Mondlane, como projeto Semestral na cadeira de
            Desenvolvimento de Aplicacoes WEB.</p>
        <div class="d-grid gap-2 d-md-block">
            <a href="http://localhost/Sistema/ver-reserva.php"><button type="button" class="btn btn-primary btn-lg" style="margin:50px;">Ver Reserva </button></a>
            <a href="http://localhost/Sistema/procurar.php"><button type="submit" class="btn btn-primary btn-lg" style="margin:50px;">Procurar </button></a>
        </div>
    </div>
    ...
    <div class="row localizacao" style="padding: 40px 0; text-align: center;">
        <div class="content">
            <h1 style="margin-bottom: 10px; text-align: center; color: #2c3e50;">Localização</h1>
            <p style="color: black;">Estamos próximos de qualquer ponto de interesse da grande cidade de Maputo.
                Poderá apanhar qualquer transporte</p>
            <p style="color: black;">junto ao nosso hotel ou aventurar-se por si.</p>
            <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-outline-success" type="button">DESCUBRA MAIS</button>
            </div>
        </div>
    </div>
