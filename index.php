    ...
    <div class="card" id="telalogin">
        ...
        <div class="card-body">
            <form action="" method="POST">
                ...
                <div id="forgotPassword" class="form-text"><a href="">Esqueceu senha?</a></div>
                <div id="criar-conta" class="form-text">Nao tens uma conta? <a href="./criar-user.php"> Criar conta</a></div>
            </form>
        </div>
    </div>
